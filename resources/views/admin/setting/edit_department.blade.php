...
<div class="col-lg-12">
    <div class="white_card card_height_100 mb_30">
        ...
        <div class="white_card_body">
            <div class="card-body">
                <form action="{{url('admin/job-setting/edit_department/'.$department->id)}}" method="post">
                    @csrf
                    <div class="row mb-3">
                    <div class="col-md-4 mb-4 mt-2">
                            <label for="">Name</label>
                            <input type="text" name="department_name" value="{{$department->name}}" class="form-control" placeholder="Enter Name"
                                id="">
                        </div>
