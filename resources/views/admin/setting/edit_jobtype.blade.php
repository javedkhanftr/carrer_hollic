        ...
        <div class="white_card_header">
            <div class="box_header m-0">
                <div class="main-title">
                    <h3 class="m-0">Add Event Type</h3>
                </div>
            </div>
        </div>
        <div class="white_card_body">
            <div class="card-body">
                <form action="{{url('admin/job-setting/edit_jobtype/'.$jobtype->id)}}" method="post">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-md-6 mb-4 mt-2">
                            <label for="">Name</label>
                            <input type="text" value="{{$jobtype->name}}" name="jobtype_name" class="form-control" placeholder="Enter Name" id="">
                        </div>
                        <div class="col-md-6 mb-4 mt-2">
                            <label for="">Brief</label>
                            <input type="text" value="{{$jobtype->brief}}" name="jobtype_brief" class="form-control" placeholder="Enter Brief"
                                id="">
                        </div>
                        <div class="col-md-12">
