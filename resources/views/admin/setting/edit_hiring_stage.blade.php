...
<div class="col-lg-12">
    <div class="white_card card_height_100 mb_30">
        ...
        <div class="white_card_body">
            <div class="card-body">
                <form action="{{url('admin/job-setting/edit_stage/'.$stage->id)}}" method="post">
                    @csrf
                    <div class="row mb-3">
                    <div class="col-md-4 mt-2">
                            <label for="">Name</label>
                            <input type="text" name="stage_name" class="form-control" value="{{$stage->name}}" placeholder="Enter Name" id="">
                        </div>
