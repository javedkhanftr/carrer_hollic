                    ...
                    <div class="col-md-3 mt-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6><a href="{{url('admin/dashboard/preview/'.$item->slug.'/display')}}"
                                                    class="text-size-18">{{$item['name']}}</a></h6>
                                <p><i class="fa fa-envelope-o " aria-hidden="true"></i>
                                    <font class="ml-3">careerhollic@gmail.com</font>
                                </p>
                                <p><i class="fa fa-map-marker " aria-hidden="true"></i>
                                    <font class="ml-3">{{ $jobsData::getLoation($item->company_location_id) }}</font>
                                </p>
                                <p><i class="fa fa-calendar " aria-hidden="true"></i>
                                    <font class="ml-3">{{ $jobsData::getdate($item->last_submission_date) }} Ago</font>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row findjobData">
                ...
                <div class="col-12 text-center ">
                    <a href="{{url('user/readMore')}}" class="btn btn-sm btn-primary mt-4 mb-5">READ MORE!</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="col-md-4 mt-3 ">
                <div class="card shadow-lg p-2 mb-4 bg-body rounded">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <img width="100px" class="   rounded-circle " src="{{asset('img/Ellipse 2.png')}}"
                                    alt="">
                            </div>
                            ...
                            <div class="col-12">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus eaque veniam
