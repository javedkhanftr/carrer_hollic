                ...
                <div class="card-body">
                    <nav>
                        <div class="nav nav-tabs mb-5">
                            <a data-toggle="tab" href="#Overview" class="nav-item p-primary text-capitalize active ">
                                <span class="mr-2 "><i class="fa fa-th pl-3 pr-3"></i>Overview</span>
                            </a>
                            <a data-toggle="tab" href="#Candidates" class="nav-item p-primary text-capitalize">
