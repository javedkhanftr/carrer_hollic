...
<div class="container-fluid">
    ...
    <div class="row mt-2 mb-4">
        ...
        <div class="col-md-4 text-end mt-2">
            <button type="button" class="btn btn-success btn-with-shadow mb-4" data-bs-toggle="modal"
                data-bs-target="#verifyEmailData">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="feather feather-plus size-20 mr-2">
                    <line x1="12" y1="5" x2="12" y2="19"></line>
                    <line x1="5" y1="12" x2="19" y2="12"></line>
                </svg>
                Add candidate
            </button>
            <!-- <a href="" class="btn btn-md btn-success" data-bs-toggle="modal" data-bs-target="#verifyEmailData"><i
                    class="fa fa-plus"> Add Candidates</i></a> -->
        </div>
    </div>
    <div class="bg-white  ">
        <div class="">
            <table class="table table-sm bg-white table-borderless" id="example">
                <thead>
                    <tr>
                        <th>Profile</th>
                        <th>Applied Job</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="no-img rounded-circle avatar-shadow  text-light"
                                        style="background-color:black;">
                                        {{$candidates->first_name[0].$candidates->last_name[0]}}</div>
                                </div>
                                <div class="col-md-8 x ml-2">
                                    <a class="text-primary " href="{{url('condidate_data/'.$candidates->id)}}"
                                        data-id="{{$candidates->id}}">{{$candidates->first_name.' '.$candidates->last_name}}</a>
                                    <p style="font-size:10px;">{{$candidates->email}} <br>{{$candidates->mobile_number}}</p>
                        ...
                        <td class="allbtn">
                            <span>
                                <div class="d-flex align-items-center" table-id="candidates-table" index="2">
                                    ...
                                    <span class="badge   text-capitalize" style="background-color: #964ed8;">In
                                        Progress</span>
                                    @endif
                        ...
                        <td>
                            <a href="{{url('candidates/edit/'.$candidates->applicant_id)}}"
                                class="btn btn-sm btn-primary badge">
                                edit
                                <!-- <i class="fa fa-edit"></i> -->
                            </a>
                            <a href="{{url('candidates/edit/'.$candidates->applicant_id)}}"
                                class="btn btn-sm btn-success badge">
                                Assign
                                <!-- <i class="fa fa-edit"></i> -->
                            </a>
                            <a href="{{url('candidates/delete/'.$candidates->applicant_id)}}"
                            ...
                            <!-- <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item" href="#">Assign Job</a></li>
                                    <li><button class="dropdown-item editCondidate" type="button" >Edit</button></li>
                                    <li class=><button class="dropdown-item deleteCondidate" type="button" data-id="{{$candidates->id}}">Delete</button></li>
                                </ul> -->
        </div>
        </td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="text-size-25 d-flex align-items-center justify-content-between"><span>Not reviewed
                                yet</span>
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-5">
                            <div class="d-flex align-items-center default-actions"><a href="#" data-toggle="tooltip"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="feather feather-minus-circle size-26">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="feather feather-mail size-26">
                                        <path
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="feather feather-calendar size-26">
                                            ...
                                            <div class="note-toolbar card-header" role="toolbar">
                                                ...
                                                <div class="note-btn-group btn-group note-fontsize">
                                                    <div class="note-btn-group btn-group"><button type="button"
                                                            ...
                                                            aria-label="Font Size" data-original-title="Font Size"><span
                                                                class="note-current-fontsize">13</span></button>
                                                        <div class="note-dropdown-menu dropdown-menu note-check dropdown-fontsize"
                                                            role="list" aria-label="Font Size"><a class="dropdown-item"
                                                                href="#" data-value="8" role="listitem"
                                                                aria-label="8"><i class="note-icon-menu-check"></i>
                                                                8</a><a class="dropdown-item" href="#" data-value="9"
                                                                role="listitem" aria-label="9"><i
                                            ...
                                            <div class="note-popover popover in note-table-popover bottom"
                                                ...
                                                <div class="popover-content note-children-container">
                                                    <div class="note-btn-group btn-group note-add"><button type="button"
                                                            class="note-btn btn btn-light btn-sm btn-md" tabindex="-1"
                                                            title="" aria-label="Add row below"
                                                            data-original-title="Add row below"><i
                                                                class="note-icon-row-below"></i></button><button
                                                            type="button" class="note-btn btn btn-light btn-sm btn-md"
